class RepeatOptions {
  ...
  RepeatOptions.fromMap(Map<String, dynamic> data): id = data['id'], startDate = data['startDate'], endDate = data['endDate'], numRepetition = data['numRepetition'], cycleLength = data['cycleLength'], recurUnitId  = data['recurUnitId'];
