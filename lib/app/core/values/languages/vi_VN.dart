const Map<String, String> viLanguagePackage = {
  ...
  'Next occurrence': 'Ngày tiếp theo',
  'Recurring every': 'Lặp theo chu kì',
  'days': 'ngày',
  'weeks': 'tuần',
  'months': 'tháng',
  'years': 'năm',
  ...
  'All category': 'Tất cả hạng mục',
  'Goal': 'Mục tiêu',
  'Repeat this budget': 'Lặp lại ngân sách này',
  'Budget will renew automatically': 'Ngân sách này sẽ được làm mới một cách tự động',
  'This week': 'Tuần này',
  'Next week': 'Tuần sau',
  'This month': "Tháng này",
  ...
  'Incoming transfer': 'Chuyển khoản nhận',
  'Insurance': 'Bảo hiểm',
  'Internet bill': 'Hóa đơn internet',
  'Investment': 'Đầu tư',
  'Loan': 'Nợ nhận',
  'Makeup': 'Trang điểm',
  'Outgoing transfer': 'Chuyển khoản gửi',
  'Pay Interest': 'Trả tiền lãi',
  'Personal Item': 'Vật tư',
  'Pets': 'Thứ cưng',
  'Others': 'Thu chi khác',
  ...
  'Salary': 'Lương',
  'Sports': 'Thể thao',
  'Streaming payment': 'Tiền phim trực tuyến',
  'Transportation': 'Phí đi lại',
  'Vehicle maintenance': 'Bảo trị phương tiện',
